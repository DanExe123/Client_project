        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-700 border border-gray-200 rounded-lg">
                ...
                <template x-for="(item, index) in products" :key="index">
                    <tr class="hover:bg-gray-50">
                        <td class="border px-2 py-2">
                            <input type="text" x-model="item.barcode" class="w-full border-gray-300 rounded-md px-2 py-1 text-sm" placeholder="Scan or enter barcode" />
                        </td>
                        <td class="border px-2 py-2">
                            <select class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-200 focus:ring-opacity-50">
                                <option>Select</option>
                        ...
                        <td class="border px-2 py-2">
                            <input type="number" x-model="item.quantity" @input="updateTotal(index)" min="1" class="w-full border-gray-300 rounded-md px-2 py-1 text-sm" />
                        </td>
                        <td class="border px-2 py-2">
                            <input type="number" x-model="item.price" @input="updateTotal(index)" step="0.01" class="w-full border-gray-300 rounded-md px-2 py-1 text-sm" />
                        </td>
                        <td class="border px-2 py-2">
                            <input type="text" :value="item.total.toFixed(2)" readonly class="w-full bg-gray-100 border-gray-300 rounded-md px-2 py-1 text-sm" />
                        </td>
                        <td class="border px-2 py-2 text-center">
                            <x-button red label="Remove" class="px-2 py-1 text-xs h-8" x-on:click="removeProduct(index)" />
                        </td>
                    </tr>
                </template>
            </tbody>
