        ...
        <div wire:loading.remove wire:target="submitPO">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select wire:model="selectedSupplierId" id="supplier"
                ...
                <div>
                    ...
                    <input type="number" min="0" step="0.01" wire:model.debounce.200ms="purchase_discount"
            ...
            <div class="overflow-x-auto">
                    ...
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="border px-2 py-2 font-semibold text-right">
                                <div wire:loading
                                    wire:target="purchase_discount, updateTotal, fillProductByBarcode, fillProductByDescription"
                ...
                <div wire:poll class="pt-2 ml-2">
                    <button wire:click="addProduct" @disabled(!$selectedSupplierId)
                        class="px-4 py-2 rounded-md text-white font-semibold
                            transition duration-150 ease-in-out
                            focus:outline-none focus:ring
                            {{ $selectedSupplierId ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-400 cursor-not-allowed' }}" {{ !$selectedSupplierId ? 'disabled' : '' }}>
                        Add Product
                    </button>
                </div>
