        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <template x-for="(rs, index) in returnList" :key="index">
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4" x-text="rs.customer"></td>
              <td class="px-6 py-4"
    ...
    <div x-show="showForm" x-transition class="bg-white border border-gray-200 rounded-lg p-6 space-y-4 mt-5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select id="customer" name="customer" x-model="form.customer_id" class="w-full mt-1 border rounded px-3 py-2">
            <option value="" disabled selected>Select a customer</option>
            {{-- Make sure $customers is passed from your Livewire/PHP component --}}
  ...
  <script>
    document.addEventListener('alpine:init', () => {
      Alpine.data('returnToSupplierUI', () => ({
        ...
        customers: @json($customers ?? []), // Ensure $customers is passed to the view
        ...
        formTitle: 'Add New Customer Return',
        selectedIndex: null, // For editing functionality

        form: {
          date: '',
          customer_id: '', // Changed to customer_id for clarity and database binding
          products: [],
        ...
        saveReturn() {
          ...
          if (!this.form.date || !this.form.customer_id || this.form.products.length === 0) {
        ...
        resetForm() {
          ...
          this.formTitle = 'Add New Customer Return';
        ...
        editReturn(index) {
          ...
          this.formTitle = 'Edit Customer Return';
