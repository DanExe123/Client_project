<div>
  ...
  <div class="p-4 space-y-6 max-w-6xl mx-auto border rounded-lg border-gray-200">
    <form wire:submit.prevent="savePayments">
      ...
      <!-- Received Table from receivings table -->
      ...
      <div class="flex justify-end mt-6">
        <x-button type="button" wire:click="savePayments" wire:loading.attr="disabled" wire:target="savePayments" blue
          label="Save as Payment">
