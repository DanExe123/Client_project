...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navmenu>
                <flux:navmenu.item href="#" icon="user">Sales Releasing</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="building-storefront">Recievable Ledger</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="credit-card">Billing</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="arrow-right-start-on-rectangle">Credit/Debit</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="trash" variant="danger">Payment Application</flux:navmenu.item>
            </flux:navmenu>
            </flux:dropdown>
            ...
            <flux:navmenu>
                <flux:navmenu.item href="#" icon="user">Account payable</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="building-storefront">Payable Ledger</flux:navmenu.item>
            </flux:navmenu>
            </flux:dropdown>
            ...
            <flux:navmenu>
                <flux:navmenu.item href="#" icon="user">Sales Summary</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="building-storefront">Sales Book</flux:navmenu.item>
                <flux:navmenu.item href="#" icon="credit-card">Cash Flow</flux:navmenu.item>
            </flux:navmenu>
            </flux:dropdown>
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        ...
                        <flux:menu.item :href="route('contact-developer')"  wire:navigate>{{ __('Contact Developers') }}</flux:menu.item>
                    </div>
                    </flux:menu.radio.group>
